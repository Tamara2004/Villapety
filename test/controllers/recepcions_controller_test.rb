...
class RecepcionsControllerTest < ActionController::TestCase
  ...
  test "should create recepcion" do
    assert_difference('Recepcion.count') do
      post :create, recepcion: { apellido: @recepcion.apellido, cargo: @recepcion.cargo, nombre: @recepcion.nombre, telefono: @recepcion.telefono }
    end
  ...
  test "should update recepcion" do
    patch :update, id: @recepcion, recepcion: { apellido: @recepcion.apellido, cargo: @recepcion.cargo, nombre: @recepcion.nombre, telefono: @recepcion.telefono }
    assert_redirected_to recepcion_path(assigns(:recepcion))
  end
