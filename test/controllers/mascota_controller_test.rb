...
class MascotaControllerTest < ActionController::TestCase
  ...
  test "should create mascotum" do
    assert_difference('Mascotum.count') do
      post :create, mascotum: { edad: @mascotum.edad, nombre: @mascotum.nombre, raza: @mascotum.raza, servicio_id: @mascotum.servicio_id }
    end
  ...
  test "should update mascotum" do
    patch :update, id: @mascotum, mascotum: { edad: @mascotum.edad, nombre: @mascotum.nombre, raza: @mascotum.raza, servicio_id: @mascotum.servicio_id }
    assert_redirected_to mascotum_path(assigns(:mascotum))
  end
